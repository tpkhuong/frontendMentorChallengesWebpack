...
function LogoNavbar({ children, ...props }) {
  ...
  return (
    <div className={LogoNavbarStyles[`logo-nav-wrapper`]}>
      <Link href="/">
        <a className={LogoNavbarStyles[`logo-wrapper`]}>
      ...
      <div
        ...
        className={LogoNavbarStyles[`mobile-icons-wrapper`]}
      >
        <button
          aria-label="open mobile menu"
          className={LogoNavbarStyles[`open-btn`]}
        >
        ...
        <button
          ...
          className={LogoNavbarStyles[`close-btn`]}
        >
...
function showMobileMenu(event) {
  const classOfClickBtn = event.target
    .closest("BUTTON")
    .getAttribute("aria-label");
  const mobileNavElement = document.querySelector("[data-showmenu]");
  ...
  const objOfActions = {
    "open mobile menu": () => {
      ...
      mobileBtnsContainer.getAttribute("data-showclosebtn") == "false"
        ? mobileBtnsContainer.setAttribute("data-showclosebtn", "true")
        : null;
    },
    "close mobile menu": () => {
      ...
      mobileBtnsContainer.getAttribute("data-showclosebtn") == "true"
        ? mobileBtnsContainer.setAttribute("data-showclosebtn", "false")
        : null;
    },
  };
  // run func based on btn clicked. our obj with property of the btn clicked
  // either open mobile menu or close mobile menu
  objOfActions[classOfClickBtn]();
}
