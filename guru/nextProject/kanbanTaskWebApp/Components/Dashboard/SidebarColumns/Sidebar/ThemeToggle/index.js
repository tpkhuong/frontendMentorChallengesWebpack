...
export default function ThemeToggle({ children }) {
  ...
  const toggleThemeMethods = {
    light: function lightTheme(toggleButton, dashboard) {
      //   set theme to dark
      // change theme of app
      dashboard.getAttribute("data-apptheme") == "light"
        ? dashboard.setAttribute("data-apptheme", "dark")
        : null;
      // change value of currenttheme of toggle btn
      toggleButton.getAttribute("data-currenttheme") == "light"
        ? toggleButton.setAttribute("data-currenttheme", "dark")
        : null;
      // change aria-label value of toggle btn
    ...
    dark: function darkTheme(toggleButton, dashboard) {
      //   set theme to light
      // change theme of app
      dashboard.getAttribute("data-apptheme") == "dark"
        ? dashboard.setAttribute("data-apptheme", "light")
        : null;
      // change value of currenttheme of toggle btn
      toggleButton.getAttribute("data-currenttheme") == "dark"
        ? toggleButton.setAttribute("data-currenttheme", "light")
        : null;
      // change aria-label value of toggle btn
      toggleButton.setAttribute(
        "aria-label",
