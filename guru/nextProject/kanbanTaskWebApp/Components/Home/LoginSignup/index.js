...
export default function LoginSignup({ children, ...props }) {
  return (
    <div className={LoginSignupStyles[`form-container`]}>
      {/* icon */}
      <Link href="/">
        <a className={LoginSignupStyles[`logo`]}>
      ...
      {/* message */}
      <div className={LoginSignupStyles[`title-wrapper`]}>
        <h2>Welcome!!!</h2>
      ...
      <span className={LoginSignupStyles[`random-text`]}>or login with</span>
      {/* social media login */}
      <div className={LoginSignupStyles[`login-btns-container`]}>
        {/* github */}
        <button className={LoginSignupStyles[`social-login-btn`]}>
          <FaGithub
            data-social-login="github"
            className={LoginSignupStyles[`icon`]}
          />
        </button>
        {/* google */}
        <button className={LoginSignupStyles[`social-login-btn`]}>
          <FcGoogle
            data-social-login="google"
            className={LoginSignupStyles[`icon`]}
          />
        </button>
        {/* linkedin */}
